            ...
            <aside class="left-side sidebar-offcanvas">                
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <?php if($this->session->userdata('cargo')=="A"){?>
                        <li class="treeview">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="<?= base_url(); ?>pregunta/"><i class="fa fa-angle-double-right"></i>Preguntas</a></li>                                
                                <li><a href="<?= base_url(); ?>usuario/"><i class="fa fa-angle-double-right"></i>Usuarios</a></li>                                                               
                                
                            </ul>
                        </li>
                        <?php }; ?>
                        <li><a href="<?= base_url(); ?>quiz/"><i class="fa fa-life-ring"></i> <span>QUIZ</span></a></li>  
